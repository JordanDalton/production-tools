...
class AuthController extends Zend_Controller_Action
{
    ...
    public function init()
    {
        ...
        $this->view->headLink()->appendStylesheet('/css/api/auth/8d7e2062b62a4a745c67d280a38f3078f3ff48c3.css', 'all');
        
        // Append Login Javascript File.
        $this->view->inlineScript()->appendFile('/js/api/auth/4d6a05274bdd5437c58a5bbbdbf9554b21ecc264.js');
    }
