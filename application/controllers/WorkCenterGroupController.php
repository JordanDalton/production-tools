...
class WorkCenterGroupController extends Zend_Controller_Action
{
    ...
    {   
        ...
        // Append Stylesheet
        $this->view->headLink()->appendStylesheet('/css/gui/work-center-group/workCenterGroupIndexAction.css', 'all');
        
        // Append Javascript File.
        $this->view->inlineScript()->appendFile('/js/gui/work-center-group/workCenterGroupIndexAction.js');
