...
class WorkOrderController extends Zend_Controller_Action
{
    ...
    {    
        ...
        // Append Stylesheet
        $this->view->headLink()->appendStylesheet('/css/gui/work-order/886bf90f96c4feba300a606ac57158507c36d134.css', 'all');
        ...
        $this->view->inlineScript()->appendFile('/js/gui/work-order/9f2f243ee42b876410a188ba340c70d3c19315e4.js');
    }
    ...
    public function archivedRecordAction()
    {
        ...
        // Append Stylesheet
        $this->view->headLink()->appendStylesheet('/css/gui/work-order/7fd62e6c742d4b2aae9c807aaf57228603453d18.css', 'all');
        
        // Append Javascript File.
        $this->view->inlineScript()->appendFile('/js/gui/work-order/b37e978c7b43e2131a9ba693e5266f665c64b37d.js');
    }
